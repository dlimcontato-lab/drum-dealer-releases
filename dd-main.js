...
import { montarPainel, escalar, desenharRolo, GRADE_INICIAL, INST_IDS } from './dd-painel.js?v=20260925p13';
import { montarEdit } from './dd-edit.js?v=20260925p13';
import { criarAudio, carregarEspelho } from './dd-audio.js?v=20260925p13';
import { criarPal } from './dd-pal.js?v=20260925p13';
