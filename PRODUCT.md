...
- Nome do produto: **Drumsfull** (decisão do Diogo em 2026-09-09; no painel e no site). O plugin foi renomeado no mesmo dia: no DAW e no instalador também é Drumsfull (assets `Drumsfull-macOS.pkg` e `Drumsfull-Windows-Setup.exe`). Designação de hardware: **Rhythm Composer DD 001**.
