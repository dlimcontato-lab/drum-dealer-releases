...
- Nome do produto: **BRDRUM** (decisão do Diogo em 2026-09-09; no painel e no site). O plugin foi renomeado no mesmo dia: no DAW e no instalador também é BRDRUM (assets `BRDRUM-macOS.pkg` e `BRDRUM-Windows-Setup.exe`). Designação de hardware: **Rhythm Composer DD 001**.
