...
export const DICT = {
  pt: {
    ...
    'hero.note-1': 'Versão web de teste · é o mesmo BRDRUM do plugin, rodando aqui no navegador',
    ...
    'download.mac-sub': '.zip · instalador .pkg, tutorial PT/EN e LEIA-ME · macOS 10.15+, Intel e Apple Silicon',
    'download.win-cta': 'Baixar para Windows',
    'download.win-sub': '.zip · instalador .exe, tutorial PT/EN e LEIA-ME · Windows 10/11, 64 bits',
    ...
    'download.step3-text': 'Com o pagamento confirmado, o BRDRUM ativa na hora. Sem chave pra copiar, sem arquivo pra guardar: a licença mora na conta. Sem pagar, o plugin abre mas fica em silêncio.',
    ...
    'plans.studio-li1-html': '<b>3 computadores</b> ativos ao mesmo tempo: estúdio, notebook e o computador do parceiro',
    ...
    'plans.team-li2': 'Para produtora, dupla ou coletivo com vários computadores',
    'plans.team-cta': 'Comprar Equipe',
    'plans.period-aria': 'Período',
    'plans.period-monthly': 'Mensal',
    'plans.period-annual': 'Anual',
    'plans.period-line-monthly': 'Cobrado uma vez, vale 1 mês',
    'plans.period-line-annual': '{total} cobrado uma vez, vale 12 meses',
    ...
    'plans.title': 'Uma licença, tudo liberado',
    'plans.legend': 'Todos os recursos em qualquer período',
    'plans.img-alt': 'Painel do BRDRUM: 16 passos para 6 instrumentos, MIDI GEN com baixo e melodia, Master FX',
    'plans.por-mes': '/mês',
    'plans.economia': 'Economize {valor} em relação ao mensal',
    'plans.cta': 'Comprar licença',
    'plans.garantia': 'Pix, cartão ou boleto · sem renovação automática',
    'plans.inclui-tit': 'O que vem na licença',
    'plans.inclui1-html': '<b>Batida pronta em um clique</b> e baixo ou melodia no tom da batida, arrastáveis para o DAW',
    'plans.inclui2-html': '<b>232 samples de fábrica</b>, mais os seus, no mesmo sorteio',
    'plans.inclui3-html': '<b>Export em stems</b>: um wav por instrumento, efeitos e o mix',
    'plans.inclui4': 'VST3 e AU, Mac e Windows, em 1 computador por vez',
    'plans.inclui5': 'Todas as atualizações durante o período',
    'plans.ja-tem-html': 'Ainda na dúvida? <a href="#demo">Toque a demo</a>: é o mesmo motor do plugin. Já comprou? <a href="conta.html">Entrar na conta</a>',
    'plans.per-computador': 'por computador',
    'plans.seat-one': '{n} computador',
    'plans.seat-other': '{n} computadores',
    'common.seat-word-one': 'computador',
    'common.seat-word-other': 'computadores',
    ...
    'plans.renovar-valor': 'Renovar · {valor}',
    'conta.periodo-renovar': 'Renovar',
    ...
    'install.mac-li1-html': 'Crie sua conta e baixe o <b>BRDRUM-macOS.zip</b> no botão acima.',
    'install.mac-li2': 'Descompacte o zip e dê dois cliques no .pkg; siga o instalador (avançar, avançar, instalar).',
    ...
    'install.win-li1-html': 'Crie sua conta e baixe o <b>BRDRUM-Windows.zip</b> no botão acima.',
    'install.win-li2-html': 'Descompacte o zip e execute o .exe; siga o instalador. Se o SmartScreen avisar, clique em <b>Mais informações → Executar assim mesmo</b>.',
    ...
    'close.licenca-perpetua': 'Sua licença {plano} não tem prazo',
    'close.legenda-licenca': 'Baixe ao lado e entre com a sua conta dentro do plugin.',
    'close.renovar-cta': 'Renovar {plano}',
    ...
    'conta.criar-aviso': 'É a conta que você vai usar dentro do plugin. Guarde a senha: é ela que ativa o BRDRUM no seu computador.',
    ...
    'conta.baixar-mac': 'Baixar para Mac (.zip)',
    'conta.baixar-win': 'Baixar para Windows (.zip)',
    'conta.sessao-legend': 'Sessão',
    'conta.sair': 'Sair',
    'conta.licenca-legend': 'Licença',
    'conta.slots-empty': 'Nenhum computador ativado ainda. Entre com esta conta dentro do plugin, ou gere uma chave para outra pessoa ativar.',
    ...
    // ---------- conta.js (dinâmico) ----------
    'conta.titulo-comprar': 'Crie a conta para continuar',
    'conta.titulo-baixar': 'Crie sua conta para baixar',
    'conta.escolhido-legend': 'Você escolheu',
    'conta.escolhido-anual': 'Anual · {total}, 12 meses pagos uma vez',
    'conta.escolhido-mensal': 'Mensal · {total}, 1 mês pago uma vez',
    'conta.trocar-plano': 'trocar plano',
    ...
    'conta.pagamento-outra-aba': 'O pagamento abriu em outra aba. Quando o Mercado Pago confirmar, esta página atualiza sozinha.',
    ...
    'conta.upgrade-e-acessos': 'Fazer upgrade · {nome} · {n} computadores',
    'conta.renovar-e-acessos': 'Renovar {nome} · {n}',
    'conta.menor-que-o-seu': 'menor que o seu',
    'conta.periodo-mensal': 'Mensal',
    'conta.periodo-anual': 'Anual',
    'conta.periodo-mensal-legend': 'vale 1 mês',
    'conta.periodo-anual-legend': '12 meses, pago uma vez',
    'conta.plano-vencido-renove': 'Sua licença venceu em {data}. Escolha um plano para renovar.',
    'conta.maior-plano-title': 'Licença',
    'conta.maior-plano-text': 'Você já tem o maior plano. Precisa de mais computadores? Escreva pra gente.',
    ...
    'conta.sem-licenca-sub': 'Compre logo abaixo. A licença aparece aqui assim que o Mercado Pago confirmar.',
    'conta.licenca-brdrum': 'Licença BRDRUM',
    'conta.oc-caption': 'O que você destrava: o plugin inteiro, no Mac e no Windows, dentro do seu DAW.',
    'conta.oc-termos': 'Pix, cartão ou boleto pelo Mercado Pago · sem renovação automática · a licença cai nesta conta assim que o pagamento confirmar',
    'conta.tenho-cupom': 'Tenho um cupom',
    'conta.valor-anual-legend': '{mes}/mês · 12 meses, pago uma vez',
    'conta.valor-mensal-legend': '1 mês, pago uma vez',
    'conta.renovar-title': 'Renovar licença',
    'conta.renovar-text': 'Sua licença vale até {data}. O período que você pagar agora soma a partir dessa data.',
    'conta.renovar-text-vencida': 'Sua licença venceu em {data}. Pague um novo período para voltar a usar.',
    'conta.plano-maior-ativo': 'Seu plano tem mais computadores do que o plano à venda hoje e continua valendo até {data}. Precisa de algo? Fale com a gente.',
    'conta.licenca-texto': '{plano} · {usadas} de {total} {acessos} em uso.',
    'conta.licenca-sub-cheia-html': 'Todos os computadores do plano estão em uso. Remova um abaixo ou <b>faça upgrade</b> para mais computadores.',
    'conta.licenca-sub-livre-html': 'Cada computador ativado ocupa um lugar do plano. Entre com a conta dentro do plugin, ou <b>gere uma chave</b> para outra pessoa ativar sem saber a sua senha.',
    'conta.licenca-valida-ate': 'Válida até {data} · {periodo}',
    'conta.licenca-sem-prazo': 'Sem prazo (pagamento único antigo)',
    'conta.licenca-vencida-status': 'Licença vencida · {email}',
    'conta.licenca-vencida-texto': 'Sua licença venceu em {data}.',
    'conta.licenca-vencida-sub': 'O plugin fica sem som até renovar. Escolha um plano abaixo. Pagou de novo antes de vencer? O prazo soma a partir do vencimento.',
    'conta.renovar': 'Renovar',
    'conta.seats-legend': '{usadas} de {total} {acessos} em uso',
    'conta.seats-sem-licenca': 'sem licença',
    'conta.vaga-livre': 'Computador livre',
    'conta.vaga-livre-legend': 'gere uma chave ou entre com a conta no plugin',
    'conta.gerar-chave': 'Nova chave',
    'conta.licenca-cheia-aviso-html': 'A licença está cheia: todos os computadores estão em uso. Remova um computador acima ou <b>faça upgrade</b> para um plano com mais computadores.',
    'conta.computador-fallback': 'Computador',
    'conta.maquina-legend': 'computador via conta · {os} · visto {quando}',
    'conta.remover-vaga': 'Remover',
    'conta.remover-computador-titulo': 'Remover computador',
    'conta.remover-computador-texto-html': '<b>{nome}</b> deixa de funcionar na próxima abertura do plugin e abre espaço para outro computador.',
    'conta.vaga-liberada': 'Computador removido.',
    ...
    'conta.copiar': 'Copiar chave',
    'conta.copiar-instrucoes': 'Copiar com instruções',
    ...
    'conta.apagar-chave-texto': 'A chave deixa de funcionar e abre espaço para outro computador.',
    'conta.remover-chave-texto-html': 'O computador <b>{nome}</b> tranca na próxima renovação e abre espaço para outro.',
    'conta.chave-que-usa-fallback': 'que usa esta chave',
    'conta.gerando-chave': 'Gerando a chave…',
    'conta.nova-chave-titulo': 'Chave para outro computador',
    'conta.apelido-opcional-rotulo': 'Apelido (opcional)',
    'conta.nova-chave-texto': 'Quem receber a chave ativa o BRDRUM em um computador sem usar a sua senha.',
    'conta.criar-chave': 'Criar chave',
    'conta.chave-criada-copiada': 'Chave {codigo} criada. As instruções foram copiadas: mande para quem vai ativar.',
    'conta.chave-criada': 'Chave criada.',
    'conta.seats-full': 'Todos os computadores do plano estão em uso. Remova um ou faça upgrade.',
    ...
    'conta.pedido-periodo-mensal': 'mensal',
    'conta.pedido-periodo-anual': 'anual',
    ...
    'conta.nao-consegui-vagas': 'Não consegui ler os computadores agora. Recarregue a página em um minuto.',
    'conta.pagamento-confirmado': 'Confira o plano e o valor (e o cupom, se tiver) e aperte Pagar.',
    // neutro: sempre o mesmo texto, com ou sem licença (24/09, regra do Diogo: quem tem conta
    // sempre consegue baixar o VST)
    'conta.instalador-mac-baixando': 'O instalador para Mac está baixando. Para destravar o plugin, entre com esta conta dentro dele.',
    'conta.instalador-win-baixando': 'O instalador para Windows está baixando. Para destravar o plugin, entre com esta conta dentro dele.',
    'conta.download-nao-comecou': 'Se o download não começou, clique aqui:',
    ...
    'panel.fill-offbeat-rotulo': 'OFFBEAT da virada',
    'panel.key-do-kick': 'KEY do KICK: usa a nota do MIDI GEN em vez do TUNE',
    'panel.clear': 'CLEAR',
    'panel.rand': 'RAND',
    'panel.clear-rotulo': 'Limpar o passo a passo do {inst}',
    'panel.rand-rotulo': 'Embaralhar o passo a passo do {inst}',
    'panel.steps-rotulo': '{n} passos',
    'panel.bar-rotulo': 'Compasso {n}',
    'panel.parado': 'Parado',
  ...
  en: {
    ...
    'hero.note-1': 'Web test version · the same BRDRUM as the plugin, running here in your browser',
    ...
    'download.mac-sub': '.zip · .pkg installer, PT/EN tutorial and README · macOS 10.15+, Intel and Apple Silicon',
    'download.win-cta': 'Download for Windows',
    'download.win-sub': '.zip · .exe installer, PT/EN tutorial and README · Windows 10/11, 64-bit',
    ...
    'download.step3-text': "Once the payment is confirmed, BRDRUM activates right away. No key to copy, no file to keep: the license lives in your account. Without paying, the plugin opens but stays silent.",
    ...
    'plans.studio-li1-html': '<b>3 computers</b> active at the same time: studio, laptop and your partner\'s computer',
    ...
    'plans.team-li2': 'For a production house, duo or collective with several computers',
    'plans.team-cta': 'Buy Team',
    'plans.period-aria': 'Billing period',
    'plans.period-monthly': 'Monthly',
    'plans.period-annual': 'Annual',
    'plans.period-line-monthly': 'Charged once, valid for 1 month',
    'plans.period-line-annual': '{total} charged once, valid for 12 months',
    'plans.off-annual': '-{pct}%',
    ...
    'plans.title': 'One license, everything unlocked',
    'plans.legend': 'Every feature in any period',
    'plans.img-alt': 'BRDRUM panel: 16 steps for 6 instruments, MIDI GEN with bass and lead, Master FX',
    'plans.por-mes': '/mo',
    'plans.economia': 'Save {valor} compared to monthly',
    'plans.cta': 'Buy license',
    'plans.garantia': 'Pix, card or boleto · no auto-renewal',
    'plans.inclui-tit': 'What the license includes',
    'plans.inclui1-html': '<b>A ready beat in one click</b> plus bass or lead in the key of the beat, draggable into your DAW',
    'plans.inclui2-html': '<b>232 factory samples</b>, plus your own, in the same shuffle',
    'plans.inclui3-html': '<b>Stem export</b>: one wav per instrument, effects and the mix',
    'plans.inclui4': 'VST3 and AU, Mac and Windows, on 1 computer at a time',
    'plans.inclui5': 'Every update during the period',
    'plans.ja-tem-html': 'Still unsure? <a href="#demo">Play the demo</a>: it runs the plugin\'s own engine. Already bought? <a href="conta.html">Sign in</a>',
    'plans.per-computador': 'per computer',
    'plans.seat-one': '{n} computer',
    'plans.seat-other': '{n} computers',
    'common.seat-word-one': 'computer',
    'common.seat-word-other': 'computers',
    ...
    'plans.renovar-valor': 'Renew · {valor}',
    'conta.periodo-renovar': 'Renew',
    ...
    'install.mac-li1-html': 'Create your account and download <b>BRDRUM-macOS.zip</b> with the button above.',
    'install.mac-li2': 'Unzip it and double-click the .pkg; follow the installer (next, next, install).',
    ...
    'install.win-li1-html': 'Create your account and download <b>BRDRUM-Windows.zip</b> with the button above.',
    'install.win-li2-html': 'Unzip it and run the .exe; follow the installer. If SmartScreen warns you, click <b>More info → Run anyway</b>.',
    ...
    'close.licenca-perpetua': 'Your {plano} license has no expiry',
    'close.legenda-licenca': 'Download on the side and sign in with your account inside the plugin.',
    'close.renovar-cta': 'Renew {plano}',
    ...
    'conta.criar-aviso': "It's the account you'll use inside the plugin. Keep the password safe: it's what activates BRDRUM on your computer.",
    ...
    'conta.baixar-mac': 'Download for Mac (.zip)',
    'conta.baixar-win': 'Download for Windows (.zip)',
    'conta.sessao-legend': 'Session',
    'conta.sair': 'Sign out',
    'conta.licenca-legend': 'License',
    'conta.slots-empty': 'No computer activated yet. Sign in with this account inside the plugin, or generate a key for someone else to activate.',
    ...
    'conta.titulo-comprar': 'Create your account to continue',
    'conta.titulo-baixar': 'Create your account to download',
    'conta.escolhido-legend': 'You chose',
    'conta.escolhido-anual': 'Annual · {total}, 12 months paid once',
    'conta.escolhido-mensal': 'Monthly · {total}, paid once for 1 month',
    'conta.trocar-plano': 'change plan',
    ...
    'conta.pagamento-outra-aba': 'The payment opened in another tab. When Mercado Pago confirms it, this page updates by itself.',
    ...
    'conta.plano-e-acessos': '{nome} · {n}',
    'conta.upgrade-e-acessos': 'Upgrade · {nome} · {n} computers',
    'conta.renovar-e-acessos': 'Renew {nome} · {n}',
    'conta.menor-que-o-seu': 'smaller than yours',
    'conta.periodo-mensal': 'Monthly',
    'conta.periodo-anual': 'Annual',
    'conta.periodo-mensal-legend': 'valid for 1 month',
    'conta.periodo-anual-legend': '12 months, paid once',
    'conta.plano-vencido-renove': 'Your license expired on {data}. Pick a plan to renew.',
    'conta.maior-plano-title': 'License',
    'conta.maior-plano-text': 'You already have the biggest plan. Need more computers? Write to us.',
    ...
    'conta.sem-licenca-sub': 'Buy right below. The license shows up here as soon as Mercado Pago confirms it.',
    'conta.licenca-brdrum': 'BRDRUM license',
    'conta.oc-caption': 'What you unlock: the whole plugin, on Mac and Windows, inside your DAW.',
    'conta.oc-termos': 'Pix, card or boleto through Mercado Pago · no auto-renewal · the license lands on this account as soon as the payment is confirmed',
    'conta.tenho-cupom': 'I have a coupon',
    'conta.valor-anual-legend': '{mes}/mo · 12 months, paid once',
    'conta.valor-mensal-legend': '1 month, paid once',
    'conta.renovar-title': 'Renew license',
    'conta.renovar-text': 'Your license is valid until {data}. The period you pay now is added from that date.',
    'conta.renovar-text-vencida': 'Your license expired on {data}. Pay for a new period to use it again.',
    'conta.plano-maior-ativo': 'Your plan has more computers than the plan on sale today and stays valid until {data}. Need anything? Get in touch.',
    'conta.licenca-texto': '{plano} · {usadas} of {total} {acessos} in use.',
    'conta.licenca-sub-cheia-html': "All the plan's computers are in use. Remove one below or <b>upgrade</b> for more computers.",
    'conta.licenca-sub-livre-html': "Each activated computer takes one of the plan's spots. Sign in with this account inside the plugin, or <b>generate a key</b> for someone else to activate without your password.",
    'conta.licenca-valida-ate': 'Valid until {data} · {periodo}',
    'conta.licenca-sem-prazo': 'No expiry (legacy one-time purchase)',
    'conta.licenca-vencida-status': 'License expired · {email}',
    'conta.licenca-vencida-texto': 'Your license expired on {data}.',
    'conta.licenca-vencida-sub': 'The plugin stays silent until you renew. Pick a plan below. Paid again before it expired? The new period adds on top of the current one.',
    'conta.renovar': 'Renew',
    'conta.seats-legend': '{usadas} of {total} {acessos} in use',
    'conta.seats-sem-licenca': 'no license',
    'conta.vaga-livre': 'Free computer',
    'conta.vaga-livre-legend': 'generate a key or sign in with this account in the plugin',
    'conta.gerar-chave': 'New key',
    'conta.licenca-cheia-aviso-html': 'The license is full: every computer is in use. Remove one above or <b>upgrade</b> to a plan with more computers.',
    'conta.computador-fallback': 'Computer',
    'conta.maquina-legend': 'computer via account · {os} · seen {quando}',
    'conta.remover-vaga': 'Remove',
    'conta.remover-computador-titulo': 'Remove computer',
    'conta.remover-computador-texto-html': "<b>{nome}</b> stops working the next time the plugin opens and opens up space for another computer.",
    'conta.vaga-liberada': 'Computer removed.',
    ...
    'conta.copiar': 'Copy key',
    'conta.copiar-instrucoes': 'Copy with instructions',
    ...
    'conta.apagar-chave-texto': 'The key stops working and opens up space for another computer.',
    'conta.remover-chave-texto-html': "The computer <b>{nome}</b> locks on its next renewal and opens up space for another.",
    'conta.chave-que-usa-fallback': 'using this key',
    'conta.gerando-chave': 'Generating the key…',
    'conta.nova-chave-titulo': 'Key for another computer',
    'conta.apelido-opcional-rotulo': 'Nickname (optional)',
    'conta.nova-chave-texto': "Whoever gets the key activates BRDRUM on one computer without your password.",
    'conta.criar-chave': 'Create key',
    'conta.chave-criada-copiada': 'Key {codigo} created. The instructions were copied: send them to whoever will activate it.',
    'conta.chave-criada': 'Key created.',
    'conta.seats-full': "All the plan's computers are in use. Remove one or upgrade.",
    'conta.pack-fallback': 'Pack',
    ...
    'conta.pedido-periodo-mensal': 'monthly',
    'conta.pedido-periodo-anual': 'annual',
    ...
    'conta.nao-consegui-vagas': "Couldn't read the computers right now. Reload the page in a minute.",
    'conta.pagamento-confirmado': 'Check the plan and the price (and the coupon, if any) and hit Pay.',
    // neutral: same text with or without a license (24/09, Diogo's rule: anyone with an account
    // can always download the VST)
    'conta.instalador-mac-baixando': 'The Mac installer is downloading. To unlock the plugin, sign in with this account inside it.',
    'conta.instalador-win-baixando': 'The Windows installer is downloading. To unlock the plugin, sign in with this account inside it.',
    'conta.download-nao-comecou': 'If the download did not start, click here:',
    ...
    'panel.fill-offbeat-rotulo': 'Fill OFFBEAT',
    'panel.key-do-kick': 'KICK KEY: uses the MIDI GEN note instead of TUNE',
    'panel.clear': 'CLEAR',
    'panel.rand': 'RAND',
    'panel.clear-rotulo': 'Clear the {inst} step pattern',
    'panel.rand-rotulo': 'Shuffle the {inst} step pattern',
    'panel.steps-rotulo': '{n} steps',
    'panel.bar-rotulo': 'Bar {n}',
